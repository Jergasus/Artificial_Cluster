...
class Procesador {
    ...
    */
    ...
    int consultar_num_procesos() const;
    ...
    */
    ...
    /** @brief Espacio que queda disponible en memoria.
    */
    int espacio_libre;

    /** @brief Espacio total que tiene la memoria.
    */
    int espacio_total;

    /** @brief Mapa de memoria. La llave hace referencia a la posición del proceso. El valor
        hace referencia a un proceso.
    */
    map<int, Proceso> memoria;

    /** @brief Mapa de identificador-posición. La llave hace referencia al identificador del proceso.
        El valor hace referencia a la posición del proceso en memoria.
    */
    map<int, int> ident_pos;

    /** @brief Mapa de huecos. La llave hace referencia al valor del hueco. El valor hace referencia a las posiciones
        en las cuales se encuentra un hueco de dicho valor.
    */
